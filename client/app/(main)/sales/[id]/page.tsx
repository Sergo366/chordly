...
export default function SaleDetailsPage() {
  ...
  const mockItem = {
    ...
    currency: 'USD',
    isNegotiable: true,
    description: 'Beautiful vintage leather jacket in excellent condition. Has a nice patina and very comfortable fit. Worn only a few times last season. Genuine cowhide leather with brass hardware. Perfect for autumn and spring weather.',
          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-stone-500 text-sm">
                  Listed {mockItem.createdAt}
                </span>
              </div>
              <h1 className="text-3xl font-bold text-white mb-4">{mockItem.title}</h1>
              
              <div className="flex items-baseline gap-3">
                <span className="text-4xl font-bold text-green-400">
                  ${mockItem.price}
                </span>
                {mockItem.isNegotiable && (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                ...
                <p className="text-white font-medium">{mockItem.brand}</p>
              </div>
              <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                <p className="text-stone-500 text-xs uppercase mb-1">Size</p>
                <p className="text-white font-medium">{mockItem.size}</p>
              </div>
              <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                <p className="text-stone-500 text-xs uppercase mb-1">Condition</p>
                <p className="text-white font-medium">{mockItem.condition}</p>
              </div>
              <div className="bg-white/5 border border-white/5 rounded-xl p-4">
            ...
            <div className="bg-[#1A1A1E] border border-white/10 rounded-2xl p-6">
              <h3 className="text-sm text-stone-400 uppercase tracking-wider font-semibold mb-4">About the Seller</h3>
